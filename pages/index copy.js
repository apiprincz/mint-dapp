        ...
        return (
          ...
          >
            ...
            <Grid xs={12} style={{ width: "90%" }}>
              ...
              <Grid xs={12}>
                <Progress
                  percent={Math.floor(((totalAmountMinted + 140) * 100) / maxSupply)}
                />
              </Grid>
            </Grid>
  ...
  function renderSoldOut() {
    return(
      <div>
        {maxSupply}
        Sold Out!<br></br>
        <Link href="/" className='opensea'> Get Tiddles on Opensea <CallMadeIcon/></Link>
      </div>
    )
}
  return (
            ...
            <Grid style={{ minHeight: "60vh" }}>
              {whitelistMintStage !== 1 && publicMintStage !==2  ? (
                ...
                >
                  ...
                  {(totalAmountMinted + 140 >= maxSupply) ? renderSoldOut() :  'MINT HAS NOT STARTED'}
                  
                </Grid>
              ) : (
                <Grid>
                  {(totalAmountMinted + 140 >= maxSupply) ? renderSoldOut() :  renderMint()}
